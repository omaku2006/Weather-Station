      ...
      <div className="aboutDetailed">
        <div className="aboutTop">
          <div className="aboutTopLeft scrollElement">
            ...
            <p>
              ...
              <b>"Why should weather apps be boring?"</b>As my <b>first React project</b>, I wanted
              to challenge myself — not just to build something functional, but to create something{' '}
              <b>visually stunning</b> and <b>meaningful</b>. The result? A weather application that
              doesn't just tell you the forecast — it <b>shows</b>
              you.
            </p>
          </div>
        ...
        <div className="aboutBottom">
          ...
          <div className="aboutBottomRight scrollElement">
            ...
            <p>
              I believe <b>design is not just how it looks, but how it makes you feel.</b>That's why
            ...
            <ul>
              ...
              <li>
                <p>
                  <b>Dynamic Backgrounds - </b>Real images from Unsplash & Pexels that change based
                  on weather conditions <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;→ Rainy? See beautiful rain photography <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;→ Sunny? Vibrant clear sky images <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;→ No reading needed — the background tells the
                  story!
                </p>
              </li>
              <li>
                <p>
                  <b>Live Sun & Moon Position Tracker - </b>A curved visualization showing the exact
                  position of the sun and moon based on real-time calculations — updated every
                  minute!
                </p>
              </li>
            </ul>
        ...
        <div className="aboutThird">
          <div className="aboutThirdTop">
            <div className="aboutThirdTopLeft scrollElement">
              ...
              <ul>
                ...
                <li>
                  <b>Comprehensive Metrics </b> : Humidity, UV index, visibility, pressure, and more
                </li>
                <li>
                  <b>Transparent Data </b> : If data isn't available, we show "--" instead of hiding
                  it
                </li>
              </ul>
              <p>Smart Updates:</p>
          ...
          <div className="aboutThirdDown">
            <div className="aboutThirdDownLeft scrollElement">
              <img src="/public/My Image.jpg" alt="Om Upadhyay Imahe" />
            </div>
            <div className="aboutThirdDownRight scrollElement">
              ...
              <ul>
                ...
                <li>
                  <b>🌱 Learning & Growing</b> — From zero projects to building a full-stack weather
                  app with React
                </li>
              </ul>
          ...
          <div className="aboutLastWrap">
            <div className="aboutLast scrollElement">
              ...
              <p>
                Weather Station is <b>100% Open Source</b> and built with <b>free tools</b> because
              ...
              <p>
                <ArrowRight />
                Immense gratitude to <b>wttr.in</b> for delivering accurate, real-time weather data
                that powers every forecast. Their simple yet powerful API is the backbone of this
                weather station.
              </p>
              <p>
                <ArrowRight />
              ...
              <p>
                ...
                Whenever I was stuck, it didn’t hand me ready-made code. Instead, it helped me
              ...
              <p className="closing">
                ...
                mine, but my learning journey wouldn’t have been this smooth without your guidance.
                🌱
              </p>
              <h1>
