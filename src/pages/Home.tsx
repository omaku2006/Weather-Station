        ...
        <div className="features">
          ...
          <div className="content">
            ...
            <div className="info scrollElement">
              ...
              <div className="infoContent">
                ...
                <p>
                  Monitor humidity levels to stay comfortable and predict precipitation. Keep track
                  of atmospheric pressure changes – a key indicator of upcoming weather shifts.
                </p>
              </div>
            </div>
            <div className="info scrollElement">
            ...
            <div className="info scrollElement">
              ...
              <div className="infoContent">
                ...
                <p>
                  ...
                  features keep ticking in real-time. This clever balance gives you the best of both
                  worlds: accurate current conditions with lively, moving elements.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="homeCardContainer">
              <div className="content cardContent">
                ...
                <article className="homeCard scrollElement">
                  ...
                  <p>
                    Enter any city name and see weather-appropriate images as your background. Every
                    refresh brings a new image—sourced from Unsplash and Pexels. Fresh, immersive,
                    every time.
                  </p>
                </article>
              </div>
          ...
          <div id="specialThanks" className="scrollElement">
            <div className="title">
              ...
              <p>
                This weather station wouldn't be possible without the generous contributions of the
            ...
            <ul>
              ...
              <li>
                <b>Pexels</b> – For their extensive collection of high-quality, royalty-free images
              </li>
              <li>
